...
#define TYPE_VENDOR_KERNEL      50UL
#if defined(CONFIG_ENABLE_L4T_RECOVERY)
#define TYPE_RECOVERY_IMG       51UL
#define TYPE_RECOVERY_DTB       52UL
#define TYPE_KERNEL_BOOTCTRL    53UL
#define TYPE_PARTITIONTABLE_LEVEL2 54UL

#define TYPE_INVALID            55UL
#define TYPE_BLACKLIST_INFO_1   56UL
#define TYPE_MAX                57UL
#else
#define TYPE_PARTITIONTABLE_LEVEL2 51UL

#define TYPE_INVALID            52UL
#define TYPE_BLACKLIST_INFO_1   53UL
#define TYPE_MAX                54UL
#endif
...
#define TEGRABL_BINARY_VENDOR_KERNEL TYPE_VENDOR_KERNEL
	/* MBR */
